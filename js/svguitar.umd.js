    ...
    var SVGuitarChord = /** @class */ (function () {
        ...
        SVGuitarChord.prototype.drawTunings = function (y) {
            ...
            tuning.forEach(function (tuning_, i) {
                if (i < strings) {
                    ...
                    var tuningText = _this.renderer.text(tuning_, stringXPositions[i], y + padding, tuningsFontSize, color, fontFamily, Alignment.MIDDLE, classNames);
                    if (tuning_) {
                        text = tuningText;
                    }
                }
        ...
        SVGuitarChord.prototype.drawEmptyStringIndicators = function (y) {
            ...
            this.chordInternal.fingers
                ...
                if (value === OPEN) {
                    ...
                    _this.renderer.circle(stringXPositions[stringIndex] - size / 2, y + padding, size, effectiveStrokeWidth, effectiveStrokeColor, undefined, classNames);
                }
                else {
                    // draw an X
                    var classNames = [
                    ...
                    _this.renderer.line(startX, startY, endX, endY, effectiveStrokeWidth, effectiveStrokeColor, classNames);
                    _this.renderer.line(startX, endY, endX, startY, effectiveStrokeWidth, effectiveStrokeColor, classNames);
                }
            });
        ...
        SVGuitarChord.prototype.drawGrid = function (y) {
            ...
            fretYPositions.forEach(function (fretY, i) {
                ...
                _this.renderer.line(startX, fretY, endX, fretY, strokeWidth, fretColor, classNames);
            });
            // draw strings
            stringXPositions.forEach(function (stringX, i) {
                var classNames = [exports.ElementType.STRING, exports.ElementType.STRING + "-" + i];
                _this.renderer.line(stringX, y, stringX, y + height + strokeWidth / 2, strokeWidth, fretColor, classNames);
            });
            // draw barre chords
            this.chordInternal.barres.forEach(function (_a) {
                ...
                _this.renderer.rect(fromStringX - stringSpacing / 4, barreCenterY - nutSize / 2, distance + stringSpacing / 2, nutSize, barreChordStrokeWidth, barreChordStrokeColor, classNames, color !== null && color !== void 0 ? color : nutColor, nutSize * barreChordRadius);
                // draw text on the barre chord
                if (text) {
                    var textClassNames = [exports.ElementType.BARRE_TEXT, exports.ElementType.BARRE_TEXT + "-" + fret];
                    _this.renderer.text(text, fromStringX + distance / 2, barreCenterY, nutTextSize, textColor !== null && textColor !== void 0 ? textColor : nutTextColor, fontFamily, Alignment.MIDDLE, textClassNames, true);
                }
            });
            // draw fingers
            this.chordInternal.fingers
        ...
        SVGuitarChord.prototype.drawNut = function (x, y, size, color, textSize, fontFamily, fingerOptions, classNames) {
            ...
            switch (shape) {
                case exports.Shape.CIRCLE:
                    this.renderer.circle(startX, startY, size, nutStrokeWidth, nutStrokeColor, (_k = fingerOptions.color) !== null && _k !== void 0 ? _k : color, classNamesWithShape);
                    break;
                case exports.Shape.SQUARE:
                    this.renderer.rect(startX, startY, size, size, nutStrokeWidth, nutStrokeColor, classNamesWithShape, (_l = fingerOptions.color) !== null && _l !== void 0 ? _l : color);
                    break;
                case exports.Shape.TRIANGLE:
                    this.renderer.triangle(startX, startY, size, nutStrokeWidth, nutStrokeColor, classNamesWithShape, (_m = fingerOptions.color) !== null && _m !== void 0 ? _m : color);
                    break;
                case exports.Shape.PENTAGON:
                    this.renderer.pentagon(startX, startY, size, nutStrokeWidth, nutStrokeColor, (_o = fingerOptions.color) !== null && _o !== void 0 ? _o : color, classNamesWithShape);
                    break;
                default:
            ...
            if (fingerOptions.text) {
                this.renderer.text(fingerOptions.text, x, y, textSize, (_p = fingerOptions.textColor) !== null && _p !== void 0 ? _p : nutTextColor, fontFamily, Alignment.MIDDLE, textClassNames, true);
            }
        };
        SVGuitarChord.prototype.drawTitle = function (size) {
            ...
            // draw the title
            var _f = this.renderer.text(title, constants.width / 2, 5, size, color, fontFamily, Alignment.MIDDLE, exports.ElementType.TITLE), x = _f.x, y = _f.y, width = _f.width, height = _f.height, remove = _f.remove;
